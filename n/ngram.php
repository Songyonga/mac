...
<div class="container">
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hanziData'])) {
      ...
      // 한자 추출
      preg_match_all('/[\x{4E00}-\x{9FFF}\x{F900}-\x{FAFF}]/u', $data, $matches);
      ...
      echo "<div class='mt-4'>";
      echo "<h4 class='text-success'> 한자는 총 <strong>$hanzi_count</strong>개의 한자로 이루어져 있습니다.</h4>";
